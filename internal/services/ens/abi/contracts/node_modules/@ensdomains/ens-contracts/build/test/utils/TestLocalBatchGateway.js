...
import { fetchBatchGateway, serveBatchGateway, } from '../fixtures/localBatchGateway.js';
...
describe('TestLocalBatchGateway', () => {
    it('OffchainDNSOracle', async () => {
        ...
        const [failures, responses] = await fetchBatchGateway(localBatchGatewayUrl, domains.map((x) => ({
            sender: zeroAddress,
