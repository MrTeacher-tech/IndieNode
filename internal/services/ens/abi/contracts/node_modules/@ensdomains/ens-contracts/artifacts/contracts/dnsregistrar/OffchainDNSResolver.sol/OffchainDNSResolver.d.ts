...
export interface OffchainDNSResolver$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "OffchainDNSResolver",
...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "OffchainDNSResolver",
    constructorArgs: [_ens: AbiParameterToPrimitiveType<{"name":"_ens","type":"address"}>, _oracle: AbiParameterToPrimitiveType<{"name":"_oracle","type":"address"}>, _gatewayURL: AbiParameterToPrimitiveType<{"name":"_gatewayURL","type":"string"}>],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<OffchainDNSResolver$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/dnsregistrar/OffchainDNSResolver.sol:OffchainDNSResolver",
    constructorArgs: [_ens: AbiParameterToPrimitiveType<{"name":"_ens","type":"address"}>, _oracle: AbiParameterToPrimitiveType<{"name":"_oracle","type":"address"}>, _gatewayURL: AbiParameterToPrimitiveType<{"name":"_gatewayURL","type":"string"}>],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<OffchainDNSResolver$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<OffchainDNSResolver$Type["abi"]>;
