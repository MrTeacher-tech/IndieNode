...
import { bytesToHex, encodeAbiParameters, encodeFunctionData, namehash, stringToHex, } from 'viem';
...
describe('ExtendedDNSResolver', () => {
    ...
    describe('t records', () => {
        it('decodes an unquoted t record', async () => {
            ...
            })).resolves.toEqual(encodeAbiParameters([{ type: 'string' }], ['nicksdjohnson']));
        });
        ...
        it('decodes a quoted t record', async () => {
            ...
            })).resolves.toEqual(encodeAbiParameters([{ type: 'string' }], ['https://ens.domains/']));
        });
        it('handles escaped quotes', async () => {
            ...
            })).resolves.toEqual(encodeAbiParameters([{ type: 'string' }], ["I'm great"]));
        });
