...
replace (
	berty.tech/go-orbit-db => berty.tech/go-orbit-db v1.21.0
	github.com/fyne-io/gl-js => github.com/fyne-io/gl-js v0.0.0-20220119005834-d2da28d9ccfe
	github.com/fyne-io/glfw-js => github.com/fyne-io/glfw-js v0.0.0-20220120001248-ee7290d23504
	github.com/ipfs/go-ipld-format => github.com/ipfs/go-ipld-format v0.4.0
	github.com/ipfs/go-ipld-legacy => github.com/ipfs/go-ipld-legacy v0.1.1
	github.com/ipfs/go-merkledag => github.com/ipfs/go-merkledag v0.8.1
	github.com/libp2p/go-libp2p-core => github.com/libp2p/go-libp2p-core v0.20.0
)
