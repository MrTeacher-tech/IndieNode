...
const func = async function (hre) {
    ...
    if (resolver === hardhat_1.ethers.constants.AddressZero) {
        console.log(`No resolver set for .eth; not setting interface ${interfaceId} for NameWrapper`);
        return;
    }
    const resolverContract = await hardhat_1.ethers.getContractAt('OwnedResolver', resolver);
